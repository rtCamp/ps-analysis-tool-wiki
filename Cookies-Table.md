PSAT Cookies table provides functionality similar to the cookies table in DevTools' Application panel, with some additions tailored for debugging scenarios in environments where unrestricted 3P cookies have been blocked.
