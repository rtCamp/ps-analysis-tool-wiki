...
How to switch to Node version 18.
...
The sidebar allows users to navigate between the aggregated reports and individual frames and filter all cookies with issues. Navigation can be done via the sidebar or by clicking on the numbers on the Cookies Insights Page.
...
The generated .zip file contains the following report files:
  ...
  - **report.html:** This file contains the summary of the report in HTML format, similar to the Cookies' insight page
