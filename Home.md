...
If you are a website developer, or a developer of components used by websites, and you use third-party cookies to achieve your goals, the good news is that by moving away from using unpartitioned third-party cookies and taking advantage of new privacy-preserving APIs, you can now achieve your technology goals while also protecting your users from privacy violations.
