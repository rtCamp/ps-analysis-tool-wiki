...
To access the Privacy Sandbox panel, access the URL you want to analyze, open Chrome DevTools, and navigate to the "Privacy Sandbox" tab.
...
On the right, is the landing page for the Privacy Sandbox DevTools panel, which provides access to Learn more about Privacy Sandbox, and the PSAT Dashboard. At the bottom of the page, it provides links to learn more about PSAT, report bugs and breakages, join the discussion and support forums. It also provides links to the latest Privacy Sandbox news extracted from the Privacy Sandbox site's RSS feed.

<img width="1200" alt="PSAT Landing Page Info Links" src="images/psat-landing-page/psat_v0.11.0_landing_page_quick_links_2024_09_11.png">
